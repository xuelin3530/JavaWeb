...
/**
 * Servlet implementation class ShowArtDetailServlet
 */
@WebServlet("/ShowArtDetailServlet")
public class ShowArtDetailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private IArtService ias = new ArtServiceImpl();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowArtDetailServlet() {
        super();
